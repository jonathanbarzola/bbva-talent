              ...
              >
                    ...
                    <div className="flex gap-1">
                      {[0,1,2].map(i => (
                        <div key={i} style={{
                          ...
                          animation: `blink 0.8s ease-in-out ${i*0.18}s infinite`,
                        }} />
                      ))}
                    </div>
                  )}
                ...
                <div>
                  <p
                    ...
                    style={{ color: isDone || isRunning ? "#e8eeff" : "#3d4f6e" }}
                  >
                    {step.label}
                  </p>
                  <p
                    className="font-mono leading-snug"
                    style={{ fontSize: 11, color: isDone ? step.color + "cc" : isRunning ? "#4d6080" : "#1e2d44" }}
                  >
