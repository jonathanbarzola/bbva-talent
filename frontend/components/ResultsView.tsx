  ...
  return (
    <div
      ...
      style={{
        ...
        paddingBottom: selectedIds.length > 0 ? 96 : 0,
      }}
    >
      {/* Ambient */}
          ...
          <section className="animate-fade-up" style={{ animationDelay: "0.25s" }}>
            ...
            <div className="flex items-center gap-3 mb-6 flex-wrap">
              ...
              <span className="font-mono text-xs" style={{ color: "#1e2d44" }}>
                {filteredOthers.length} perfiles
              </span>
            </div>
            ...
            {filteredOthers.length > 0 ? (
              ...
              <div
                ...
                style={{ background: "rgba(10,22,40,0.5)", border: "1px solid rgba(133,200,255,0.07)" }}
              >
                ...
                <button
                  ...
                  className="font-mono text-xs underline transition-opacity hover:opacity-80"
    ...
    <div
      ...
      style={{
        ...
        boxShadow: isSelected
          ? `0 0 60px ${BBVA.lime}14, 0 0 60px rgba(0,19,145,0.18)`
          : "0 0 60px rgba(0,19,145,0.18)",
      }}
    >
      ...
      {onSelect && (
        <button
          ...
          style={{
            background: isSelected ? `${BBVA.lime}18` : "rgba(133,200,255,0.06)",
            border: `1px solid ${isSelected ? BBVA.lime + "55" : "rgba(133,200,255,0.14)"}`,
            color: isSelected ? BBVA.lime : "#3d4f6e",
            cursor: "pointer",
          }}
        >
          {isSelected ? (
            <>
              <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
                <path d="M1.5 4.5L3.5 6.5L7.5 2.5" stroke={BBVA.lime} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              En equipo
            </>
          ) : (
            <>
              <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                <path d="M4 1V7M1 4H7" stroke="rgba(133,200,255,0.5)" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
              Agregar al equipo
            </>
          )}
        ...
        <div className="flex lg:flex-col items-center justify-between lg:justify-center gap-5 lg:w-36 flex-shrink-0">
          <div className="text-center">
            <div
              ...
              style={{ fontSize: 56, color: BBVA.lime, fontFamily: "var(--font-mono)", animation: "countUp 0.4s ease both" }}
            >
              {displayScore}
            </div>
